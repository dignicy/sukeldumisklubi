<script lang="ts">
	...
	const pageData = {
		title: 'IANTD Koolitused',
		subtitle:
			'Rahvusvaheliselt tunnustatud tehnilise sukeldumise koolitused kogenud instruktorite juhendamisel.',
	...
	<div class="mx-auto max-w-7xl px-6">
		<div class="grid gap-16 lg:grid-cols-3">
			...
			<div class="space-y-16 lg:col-span-2">
				<!-- Intro Section -->
				<div class="space-y-6">
					<h2 class="text-3xl font-bold text-gray-900">IANTD Tehnilise Sukeldumise Kursused</h2>
					<p class="text-lg text-gray-600">
						International Association of Nitrox and Technical Divers (IANTD) on üks maailma
						juhtivaid tehnilise sukeldumise organisatsioone. Meie koolitused viiakse läbi kogenud
						instruktorite poolt, kes tagavad kõrgeima õppekvaliteedi ja ohutuse.
					</p>
				</div>
